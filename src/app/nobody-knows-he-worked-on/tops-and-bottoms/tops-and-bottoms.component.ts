...
import projectData from './tops-and-bottoms.component.json';

@Component({
  selector: 'vz-tops-and-bottoms',
  templateUrl: './tops-and-bottoms.component.html',
  styleUrls: ['./tops-and-bottoms.component.scss']
})
export class TopsAndBottomsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Tops & Bottoms - Víctor Zamudio"); 
