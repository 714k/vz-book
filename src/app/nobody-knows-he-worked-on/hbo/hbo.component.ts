...
import projectData from './hbo.component.json';

@Component({
  selector: 'vz-hbo',
  templateUrl: './hbo.component.html',
  styleUrls: ['./hbo.component.scss']
})
export class HBOComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("HBO - Víctor Zamudio"); 
