...
import projectData from './sonora.component.json';

@Component({
  selector: 'vz-sonora',
  templateUrl: './sonora.component.html',
  styleUrls: ['./sonora.component.scss']
})
export class SonoraComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Sonora - Víctor Zamudio"); 
