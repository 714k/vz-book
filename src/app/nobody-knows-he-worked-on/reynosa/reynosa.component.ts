...
import projectData from './reynosa.component.json';

@Component({
  selector: 'vz-reynosa',
  templateUrl: './reynosa.component.html',
  styleUrls: ['./reynosa.component.scss']
})
export class ReynosaComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Reynosa - Víctor Zamudio"); 
