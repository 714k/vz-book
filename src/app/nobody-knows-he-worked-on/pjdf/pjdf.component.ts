...
import projectData from './pjdf.component.json';

@Component({
  selector: 'vz-pjdf',
  templateUrl: './pjdf.component.html',
  styleUrls: ['./pjdf.component.scss']
})
export class PJDFComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("PJDF - Víctor Zamudio"); 
