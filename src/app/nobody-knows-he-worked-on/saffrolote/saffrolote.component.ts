...
import projectData from './saffrolote.component.json';

@Component({
  selector: 'vz-saffrolote',
  templateUrl: './saffrolote.component.html',
  styleUrls: ['./saffrolote.component.scss']
})
export class SaffroloteComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Saffrolote - Víctor Zamudio"); 
