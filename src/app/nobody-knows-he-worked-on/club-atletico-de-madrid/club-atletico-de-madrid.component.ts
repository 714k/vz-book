...
import projectData from './club-atletico-de-madrid.component.json';

@Component({
  selector: 'vz-club-atletico-de-madrid',
  templateUrl: './club-atletico-de-madrid.component.html',
  styleUrls: ['./club-atletico-de-madrid.component.scss']
})
export class ClubAtleticoDeMadridComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Club Atlético de Madrid - Víctor Zamudio"); 
