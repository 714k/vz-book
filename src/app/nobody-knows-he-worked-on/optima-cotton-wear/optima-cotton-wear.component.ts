...
import projectData from './optima-cotton-wear.component.json';

@Component({
  selector: 'vz-optima-cotton-wear',
  templateUrl: './optima-cotton-wear.component.html',
  styleUrls: ['./optima-cotton-wear.component.scss']
})
export class OptimaCottonWearComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Optima Cotton Wear - Víctor Zamudio"); 
