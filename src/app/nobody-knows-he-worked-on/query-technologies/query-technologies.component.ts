...
import projectData from './query-technologies.component.json';

@Component({
  selector: 'vz-query-technologies',
  templateUrl: './query-technologies.component.html',
  styleUrls: ['./query-technologies.component.scss']
})
export class QueryTechnologiesComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Query Technologies - Víctor Zamudio"); 
