...
import projectData from './skiny.component.json';

@Component({
  selector: 'vz-skiny',
  templateUrl: './skiny.component.html',
  styleUrls: ['./skiny.component.scss']
})
export class SkinyComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Skiny - Víctor Zamudio"); 
