...
import projectData from './toyota-universidad.component.json';

@Component({
  selector: 'vz-toyota-universidad',
  templateUrl: './toyota-universidad.component.html',
  styleUrls: ['./toyota-universidad.component.scss']
})
export class ToyotaUniversidadComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Toyota Universidad - Víctor Zamudio"); 
