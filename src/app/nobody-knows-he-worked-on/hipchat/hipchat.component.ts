...
import projectData from './hipchat.component.json';

@Component({
  selector: 'vz-hipchat',
  templateUrl: './hipchat.component.html',
  styleUrls: ['./hipchat.component.scss']
})
export class HipchatComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Hipchat - Víctor Zamudio"); 
