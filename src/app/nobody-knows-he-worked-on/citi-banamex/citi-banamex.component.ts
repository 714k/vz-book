...
import projectData from './citi-banamex.component.json';

@Component({
  selector: 'vz-citi-banamex',
  templateUrl: './citi-banamex.component.html',
  styleUrls: ['./citi-banamex.component.scss']
})
export class CitiBanamexComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Citi Banamex - Víctor Zamudio"); 
