...
import projectData from './infotec.component.json';

@Component({
  selector: 'vz-infotec',
  templateUrl: './infotec.component.html',
  styleUrls: ['./infotec.component.scss']
})
export class InfotecComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Infotec - Víctor Zamudio"); 
