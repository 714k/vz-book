...
import projectData from './plastiq.component.json';

@Component({
  selector: 'vz-plastiq',
  templateUrl: './plastiq.component.html',
  styleUrls: ['./plastiq.component.scss']
})
export class PlastiqComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.title.setTitle("Plastiq - Víctor Zamudio"); 
